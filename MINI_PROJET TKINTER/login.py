...
def open_login(): 
    ...
    #image
    image = PhotoImage(file="login.png")  # Replace with your image file name
    resized_img = image.subsample(2, 2)

    label = Label(login, image=resized_img,bg="white")  # keep a reference
    ...
    # Place widgets using x,y coordinates
